...
export default function Page() {
    return <div className='p-5'>
        <BlogPage category={config.category}>
            ...
            <Image alt='header image' src='https://sp-ao.shortpixel.ai/client/to_webp,q_lossy,ret_img/https://jacekjeznach.com/wp-content/uploads/2022/02/co-to-jest-responsive-web-design-e1643791537179.jpg' />
            <Contents />
            <hr />
            <h2>Front End</h2>
            <p>Content</p>
